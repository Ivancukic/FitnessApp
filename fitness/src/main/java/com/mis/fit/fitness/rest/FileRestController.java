...
import com.mis.fit.fitness.service.FileStorageService;
...
public class FileRestController {
	...
	public ResponseEntity<ResponseMessage> uploadFileGallery(@RequestParam("file") MultipartFile file) {
		
		String message = "";
		
		try {
			
			storageService.storeInGallery(file);
